      ...
      try {
        ...
        if (userId) {
          ...
          if (docSnap.exists()) {
            ...
            // Count matched scholarships (all recommendations are considered matches)
            ...
            // Count saved scholarships (if you have a way to mark scholarships as saved)
            // For now, we'll assume all recommendations are saved
            setSavedCount(scholarships.length);
          }
        }
      } catch (error) {
